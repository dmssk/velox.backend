	...
	function woocommerce_breadcrumb( $args = array() ) {
		$args = wp_parse_args(
			...
			apply_filters(
				...
				array(
					'delimiter'   => '',
					'wrap_before' => '<nav class="breadcrumbs woocommerce-breadcrumb">',
					'wrap_after'  => '</nav>',
					'before'      => '',
					'after'       => '',
...
if ( ! function_exists( 'woocommerce_subcategory_thumbnail' ) ) {
	 ...
	 */
	function woocommerce_subcategory_thumbnail( $category, $class ) {
		...
		if ( $image ) {
			...
			if ( $image_srcset && $image_sizes ) {
				echo '<img src="' . esc_url( $image ) . '" alt="' . esc_attr( $category->name ) . '" class="' . $class . '" width="' . esc_attr( $dimensions['width'] ) . '" height="' . esc_attr( $dimensions['height'] ) . '" srcset="' . esc_attr( $image_srcset ) . '" sizes="' . esc_attr( $image_sizes ) . '" />';
			} else {
				echo '<img src="' . esc_url( $image ) . '" alt="' . esc_attr( $category->name ) . '" class="' . $class . '" width="' . esc_attr( $dimensions['width'] ) . '" height="' . esc_attr( $dimensions['height'] ) . '" />';
			}
		}
	}
}
